...
responses = [];
inputs = u;
varargin{1} = 'tapas_hgf_binary_config';
varargin{2} = 'tapas_bayes_optimal_binary_config';
varargin{3} = 'tapas_quasinewton_optim_config';



function r = dummy_fitModel(responses, inputs, varargin):
print(varagin);
end
