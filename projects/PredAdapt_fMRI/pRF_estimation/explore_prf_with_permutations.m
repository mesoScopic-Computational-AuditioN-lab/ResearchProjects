...
pth           = 100; % F selection thres in terms of percentiles of the empirical distribution: this code also works for all vox
selvox        = FMapTrain  > prctile(FMapTrain,100-pth)   | FMapTrain <  prctile(FMapTrain,pth );
...
for itcv = 6:(kfold+1)
    ...
    Xtr     = BetasSEPTrain(tr,:); Xte = BetasSEPTrain(te,:);% training and test betas
